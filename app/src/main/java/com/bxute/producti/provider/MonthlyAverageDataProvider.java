...
public class MonthlyAverageDataProvider implements IChartDataProvider {

  int hourMode;
  DataStore dataStore;
  LineChart mLineChart;

  public MonthlyAverageDataProvider(Context context, LineChart lineChart) {
  ...
  public LineData getLineData() {
    ArrayList<FEMModel> dataList = dataStore.getDataInRange(
     ...
     CalendarDayModel.from(LocalDate.of(2019, 2, 1))
    );
